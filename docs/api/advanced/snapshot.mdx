...
Immutability is achieved by _efficiently_ deep copying & freezing the object (see the [Copy on Write](#copyonwrite) section for details).
...
## <a name="copyonwrite"></a> Copy on Write
