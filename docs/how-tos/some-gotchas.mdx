...
<ol type="a">
  ...
  <li>Do not pass objects to components with `React.memo` (pass primitive values instead).</li>
  <li>Pass in the proxy of that element, and then `useSnapshot` on that proxy.</li>
</ol>
